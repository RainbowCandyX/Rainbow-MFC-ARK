...
BOOL CListProcessHook::OnInitDialog()
{
	...
	m_listHookInfo.InsertColumn(0, L"挂钩地址", LVCFMT_LEFT, 230);
	m_listHookInfo.InsertColumn(1, L"挂钩类型", LVCFMT_LEFT, 60);
	m_listHookInfo.InsertColumn(2, L"当前入口", LVCFMT_LEFT, 150);
