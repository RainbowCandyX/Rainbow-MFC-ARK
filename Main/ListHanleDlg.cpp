...
BOOL CListHanleDlg::OnInitDialog()
{
	...
	m_list.InsertColumn(eHandleType, L"类型", LVCFMT_LEFT, 90);
	m_list.InsertColumn(eHandleName, L"名字", LVCFMT_LEFT, 300);
	m_list.InsertColumn(eHandleValue, L"值", LVCFMT_CENTER, 90);
	m_list.InsertColumn(eHandleGranted, L"权限", LVCFMT_LEFT, 600);
	m_list.InsertColumn(eHandleObject, L"句柄对象", LVCFMT_LEFT, 90);
	m_list.InsertColumn(eHandleRefCount, L"计数", LVCFMT_CENTER, 70);
