...
BOOL CListMemoryDlg::OnInitDialog()
{
	...
	m_list.InsertColumn(eMemoryBase, L"地址", LVCFMT_LEFT, 130);
	m_list.InsertColumn(eMemorySize, L"大小", LVCFMT_LEFT, 130);
	m_list.InsertColumn(eMemoryProtect, L"保护", LVCFMT_LEFT, 130);
	m_list.InsertColumn(eMemoryVadFlags, L"Vad标志", LVCFMT_LEFT, 130);
	m_list.InsertColumn(eMemoryState, L"状态", LVCFMT_LEFT, 110);
	m_list.InsertColumn(eMemoryType, L"类型", LVCFMT_LEFT, 110);
	m_list.InsertColumn(eMmeoryModuleName, L"模块名", LVCFMT_LEFT, 430);
