...
BOOL CListModuleDlg::OnInitDialog()
{
	...
	m_listModule.InsertColumn(eDllPath, L"目录", LVCFMT_LEFT, 340);
	m_listModule.InsertColumn(eDllBase, L"地址", LVCFMT_LEFT, 140);
	m_listModule.InsertColumn(eDllSize, L"大小", LVCFMT_LEFT, 90);
	m_listModule.InsertColumn(eDllFileCompany, L"公司", LVCFMT_LEFT, 150);
	m_listModule.InsertColumn(eDllFileDescription, L"描述", LVCFMT_LEFT, 180);
