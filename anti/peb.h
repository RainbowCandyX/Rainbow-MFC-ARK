...
NTKERNELAPI VOID PsGetProcessProtection();
NTKERNELAPI VOID PsGetProcessSignatureLevel();
NTKERNELAPI VOID PsIsWin32KFilterEnabledForProcess();//>=17134
NTKERNELAPI VOID PsSetProcessWindowStation();
EXTERN_C_END
